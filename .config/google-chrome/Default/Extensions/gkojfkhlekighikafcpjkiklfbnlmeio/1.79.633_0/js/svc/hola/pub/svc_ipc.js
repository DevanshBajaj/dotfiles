...
define(['jquery', 'underscore', '/util/etask.js',
    ...
    '/util/storage.js'],
    function($, _, etask, version_util, zutil, user_agent, storage){
    ...
    return etask({cancel: true}, [function(){
        ...
        _.each(arr, function(e, i){
            ...
            if (!best_is_old && (e_order<best_order || e_order==best_order
                && version_util.cmp(e.ret.ver, best.ret.ver)<=0))
            {
                return;
            }
            best = e;
...
E.ext.lean_ping = function(){
    if (!window.chrome)
    {
        // XXX bahaa FF_WEBEXT: figure out how to do for webextension
