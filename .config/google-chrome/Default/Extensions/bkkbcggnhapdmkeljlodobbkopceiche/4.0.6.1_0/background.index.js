...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ranger = __webpack_require__(12);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function (pop) {
	  ...
	  _PBStorageSync2.default.all.update(function (settings) {
	    ...
	    settings.pb_reportData = settings.pb_reportData || {};
	  ...
	  function onRuntimeMessage(request, sender, sendResponse) {
	    switch (request.name) {
	      ...
	      case "trackEvent":
	        ...
	        break;
	      case "pageClosing":
	        _PBStorageSync2.default.pb_reportData.update(function (data) {
	          data["lastClosedURL"] = request.url;
	          return data;
	        });
	        break;
	      case "logTxt":
	  ...
	  function reportSite(info) {
	    var siteData = { referrer: '' };

	    getCurrentTabData(function (data) {
	      _PBStorageSync2.default.pb_reportData.update(function (reportData) {
	        if (data) {
	          siteData = data;
	        }

	        reportData['lastVisit'] = siteData.referrer;
	        reportData['siteWhenReport'] = info.url;
	        reportData['lastClosedURL'] = reportData.lastClosedURL || '';
	...
	var _ga = __webpack_require__(14);

	var _ga2 = _interopRequireDefault(_ga);

	var _keen = __webpack_require__(15);

	var _keen2 = _interopRequireDefault(_keen);

	var _rating = __webpack_require__(16);
